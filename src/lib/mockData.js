...
export const DEMO_USERS = [
  {
    ...
    password: 'demo1234',
    full_name: 'Thomas LEONARC',
    role: 'medicalliance',
    title: 'Directeur Réseau',
    org_id: 'org-01',
    organisations: { id: 'org-01', name: 'Medicalliance', type: 'medicalliance', region: 'Occitanie · Toulouse' },
  },
  {
    id: '10000000-0002',
...
export const LOCATIONS = [
  {
    ...
    date_debut: new Date(today.getTime() - 67 * 86400000).toISOString().split('T')[0],
    date_fin:   new Date(today.getTime() + 298 * 86400000).toISOString().split('T')[0],
  ...
  },
  {
    ...
    date_debut: new Date(today.getTime() - 110 * 86400000).toISOString().split('T')[0],
    date_fin:   new Date(today.getTime() + 255 * 86400000).toISOString().split('T')[0],
  ...
  },
  {
    ...
    date_debut: new Date(today.getTime() - 359 * 86400000).toISOString().split('T')[0],
    date_fin:   new Date(today.getTime() + 6 * 86400000).toISOString().split('T')[0],
  ...
  },
  {
    ...
    date_debut: new Date(today.getTime() - 366 * 86400000).toISOString().split('T')[0],
    date_fin:   new Date(today.getTime() - 1 * 86400000).toISOString().split('T')[0],
