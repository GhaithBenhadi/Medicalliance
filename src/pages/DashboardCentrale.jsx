    ...
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={fade} className="lg:col-span-2 surface rounded-xl p-5 shadow-card">
          <h2 className="font-semibold text-gray-900 mb-1">Activité mensuelle</h2>
          ...
          <div className="space-y-2.5">
            {devisAValider.map(d => (
              <div key={d.id} className="flex items-start gap-2.5 p-3 bg-amber-500/10 rounded-xl border border-amber-500/20">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-gray-900 truncate">{d.ref}</p>
            ...
            {locExpirantes.map(l => (
              <div key={l.id} className="flex items-start gap-2.5 p-3 bg-red-500/10 rounded-xl border border-red-500/20">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-gray-900 truncate">{l.equipement}</p>
            ...
            {mesDemandes.map(d => {
              ...
              return (
                <tr key={d.id}
                  ...
                  <td className="py-3.5 px-5 text-gray-900">{d.etablissement.name}</td>
