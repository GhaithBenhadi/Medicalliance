      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div variants={fade} className="surface rounded-xl shadow-card overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {DEMANDES.map(d => (
              <div key={d.id} className="flex items-center justify-between px-5 py-3.5 hover:bg-gray-50 transition-colors">
                <div>
                  ...
                  <p className="text-sm text-gray-800">{d.etablissement.name}</p>
