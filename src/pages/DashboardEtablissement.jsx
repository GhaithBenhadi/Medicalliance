  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              return (
                <div key={d.id} className="flex items-center justify-between px-5 py-4 hover:bg-gray-50 transition-colors">
                  <div>
                    ...
                    <p className="text-sm text-gray-800">{d.description?.slice(0, 48)}…</p>
        ...
        <motion.div variants={fade} className="surface rounded-xl shadow-card overflow-hidden">
          <div className="p-5 border-b border-gray-100">
            <h2 className="font-semibold text-gray-900">Mes locations</h2>
          </div>
          <div className="divide-y divide-gray-100">
            {mesLocations.map(l => {
              const total = 365
                ...
                <div key={l.id} className="px-5 py-4">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      ...
                      <span className="text-sm text-gray-800">{l.equipement}</span>
                    </div>
