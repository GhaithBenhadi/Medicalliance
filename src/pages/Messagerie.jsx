...
export default function Messagerie() {
  ...
  return (
    <div className="flex h-[calc(100vh-116px)] lg:h-[calc(100vh-140px)] surface rounded-xl shadow-card overflow-hidden">

      {/* ── Conversation list ──────────────────────────── */}
      <div className={[
        'flex-col border-r border-surface-100 shrink-0',
        // Mobile: full width when in list view, hidden when in chat view
        ...
        <div className="p-4 border-b border-gray-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-surface-100 rounded-lg pl-9 pr-3 py-1.5 text-sm text-gray-700 placeholder-gray-400 focus:border-brand-500 outline-none"
            />
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {filteredConvs.map(c => (
            <button
              ...
              className={`w-full text-left px-4 py-3 border-b border-surface-100 hover:bg-gray-50 transition-colors ${activeId === c.id ? 'bg-brand-500/10 border-l-2 border-l-brand-500' : ''}`}
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-gray-900 truncate">{c.contact}</span>
      ...
      <div className={[
        ...
        {active && (
          <div className="flex items-center gap-3 p-3 lg:p-4 border-b border-gray-100">
            ...
            <button
              ...
              className="lg:hidden w-8 h-8 rounded-lg hover:bg-gray-100 flex items-center justify-center text-gray-500 shrink-0 transition-colors"
            >
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold text-gray-900 truncate">{active.contact}</p>
        ...
        <div className="flex-1 overflow-y-auto p-3 lg:p-4 space-y-3">
          {activeMessages.map(m => (
            ...
            >
              <div className={`max-w-[80%] lg:max-w-md px-4 py-2.5 rounded-2xl text-sm ${
                m.from === 'me'
        ...
        {/* Input */}
        <div className="p-3 lg:p-4 border-t border-surface-100">
          <div className="flex items-center gap-2 lg:gap-3">
            <input
              ...
              className="flex-1 bg-gray-50 border border-surface-100 rounded-xl px-4 py-2.5 text-sm text-gray-700 placeholder-gray-400 focus:border-brand-500 outline-none"
            />
            <button
              onClick={handleSend}
