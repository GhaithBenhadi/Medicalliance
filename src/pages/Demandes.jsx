            ...
            {demandes.map(d => {
              ...
              return (
                <motion.tr key={d.id} variants={fade}
                  ...
                  <td className="py-3.5 px-5">
                    <div>
                      <p className="text-gray-900">{d.etablissement.name}</p>
                      <p className="text-xs text-gray-500">{d.city}</p>
                    </div>
                  </td>
                  <td className="py-3.5 px-5 max-w-xs">
                    <p className="text-gray-700 truncate">{d.description}</p>
                  </td>
                  <td className="py-3.5 px-5 text-gray-400">{CAT[d.categorie] || d.categorie}</td>
                  <td className="py-3.5 px-5 text-right text-gray-900 font-medium">{d.quantite}</td>
                  <td className="py-3.5 px-5">
                    {d.urgence === 'urgent'
